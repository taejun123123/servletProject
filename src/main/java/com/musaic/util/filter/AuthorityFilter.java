...
//		authMap.put("/image/delete.do", 1);
		authMap.put("/playlist/list.do", 1);
		
		authMap.put("/pay/adminList.do", 9);
		
		authMap.put("/pay/payorderForm.do", 1);
		authMap.put("/pay/payView.do", 1);
		authMap.put("/pay/payList.do", 1);
		authMap.put("/pay/payWriteForm.do", 1);
